...
(global-display-line-numbers-mode)
   ...
   #+end_src
** nlinum: Much faster than linum - Superseed by native line numbers
  #+BEGIN_SRC emacs-lisp
;;(use-package nlinum
;;  :ensure t
;;  :config 
...
;;  (load-theme 'doom-nord)) ;; doom-one doom-dracula doom-nord
  #+END_SRC
** Color theme follows system mode
   #+begin_src emacs-lisp
  ...
  (defun mycalendar ()
    ...
    (cfw:open-calendar-buffer
     ...
     (list
      ...
      (cfw:ical-create-source "gcal" "https://calendar.google.com/calendar/ical/woquendo%40gmail.com/public/basic.ics" "IndianRed") ; devorah calender
      (cfw:ical-create-source "gcal" "https://calendar.google.com/calendar/ical/vpo53nvma5tv0m1tmnnes7md1o%40group.calendar.google.com/public/basic.ics" "IndianRed") ; google calendar ICS
      )))
  (setq cfw:org-overwrite-default-keybinding t))
...
(use-package notmuch
  ...
  (setq user-mail-address "woquendo@gmail.com.com"
	user-full-name "William Oquendo"))
   #+end_src
* Floobits
  This is useful to share a programming session with students
   #+begin_src emacs-lisp
...
* Keypression
  This allows to show pressed keys inside emacs
  #+begin_src emacs-lisp
